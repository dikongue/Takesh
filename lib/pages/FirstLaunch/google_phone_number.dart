import 'package:etakesh_client/pages/FirstLaunch/google_phone_code.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:google_sign_in/google_sign_in.dart';

class EnterGooglePhoneNumberPage extends StatefulWidget {
  final GoogleSignInAccount user;
  EnterGooglePhoneNumberPage({Key key, this.user}) : super(key: key);
  @override
  _EnterGooglePhoneNumberPageState createState() =>
      _EnterGooglePhoneNumberPageState();
}

class _EnterGooglePhoneNumberPageState
    extends State<EnterGooglePhoneNumberPage> {
    ...
    final PhoneCodeSent smsCodeSent = (String verId, [int forceCodeResend]) {
      ...
      Navigator.push(
        ...
        new MaterialPageRoute(
            builder: (context) => EnterGooglePhoneCodePage(
